...
//
//	mockgen -destination=editormock.go -package=editormock -write_generate_directive github.com/moisesvega/diffy/internal/editor Open
//
...
//go:generate mockgen -destination=editormock.go -package=editormock -write_generate_directive github.com/moisesvega/diffy/internal/editor Open

// MockOpen is a editormock of Open interface.
type MockOpen struct {
	ctrl     *gomock.Controller
	recorder *MockOpenMockRecorder
}

// MockOpenMockRecorder is the editormock recorder for MockOpen.
type MockOpenMockRecorder struct {
	mock *MockOpen
}

// NewMockOpen creates a new editormock instance.
